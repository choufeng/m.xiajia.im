...
export function fetchGroupList(args = {}) {
  return (dispatch) => { // optionally you can have getState as the second argument
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      doRequest.then(
        (res) => {
          dispatch({
            type: ADMIN_FETCH_GROUP_LIST_SUCCESS,
            data: res.data,
          });
          resolve(res);
        },
...
export function dismissFetchGroupListError() {
  return {
...
export function reducer(state, action) {
  switch (action.type) {
    case ADMIN_FETCH_GROUP_LIST_BEGIN:
      // Just after a request is sent
      return {
        ...state,
        fetchGroupListPending: true,
        fetchGroupListError: null,
      };

    case ADMIN_FETCH_GROUP_LIST_SUCCESS:
    ...
    case ADMIN_FETCH_GROUP_LIST_FAILURE:
      // The request is failed
      return {
        ...state,
        fetchGroupListPending: false,
        fetchGroupListError: action.data.error,
      };

    case ADMIN_FETCH_GROUP_LIST_DISMISS_ERROR:
